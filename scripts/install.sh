...
# lane installer
# Usage: curl -fsSL https://raw.githubusercontent.com/candril/lane/main/scripts/install.sh | bash
#
#   LANE_VERSION=0.2.0              install a specific release instead of the latest
#   LANE_INSTALL_DIR=~/.local/bin   install somewhere other than /usr/local/bin
#
# Homebrew and Nix users have shorter routes:
#   brew install candril/tap/lane
#   nix run github:candril/lane
#
...
echo "Run 'lane --help' to get started."
