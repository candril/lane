...
<Aside type="caution">
lane is young and built spec-first — every feature traces to a numbered spec in
[`specs/`](https://github.com/candril/lane/tree/main/specs). It talks to **Jira Cloud** over the
REST API and it *writes*. Try it against a board you don't mind poking at, and expect rough edges.
</Aside>
...
See the [installation guide](/lane/guide/installation/) for credentials and first run.
